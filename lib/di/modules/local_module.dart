...
import 'package:covid19turkey/data/local/constants/db_constants.dart';
...
import 'package:covid19turkey/utils/encryption/xxtea.dart';
...
class LocalModule extends NetworkModule {
  ...
  Repository provideRepository(
    CovidApi covidApi,
    ContinentDataApi continentDataApi,
    TotalDataApi totalDataApi,
    CoronaNewsApi coronaNewsApi,
    PostApi postApi,
    SharedPreferenceHelper preferenceHelper,
    PostDataSource postDataSource,
  ) =>
      Repository(postApi, preferenceHelper, postDataSource, covidApi,
          totalDataApi, continentDataApi, coronaNewsApi);
}
