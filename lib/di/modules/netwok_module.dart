...
import 'package:covid19turkey/data/network/apis/posts/post_api.dart';
import 'package:covid19turkey/data/network/constants/endpoints.dart';
import 'package:covid19turkey/data/network/dio_client.dart';
import 'package:covid19turkey/data/network/rest_client.dart';
import 'package:covid19turkey/data/sharedpref/constants/preferences.dart';
...
class NetworkModule extends PreferenceModule {
  ...
  @provide
  @singleton
  ContinentDataApi provideContinentDataApi(
          DioClient dioClient, RestClient restClient) =>
      ContinentDataApi(dioClient, restClient);

  @provide
  @singleton
  CoronaNewsApi provideCoronaNewsApi(
          DioClient dioClient, RestClient restClient) =>
      CoronaNewsApi(dioClient, restClient);

  @provide
  @singleton
  TotalDataApi provideTotalDataApi(
          DioClient dioClient, RestClient restClient) =>
      TotalDataApi(dioClient, restClient);

  @provide
  @singleton
  CovidApi provideCovidApi(DioClient dioClient, RestClient restClient) =>
      CovidApi(dioClient, restClient);
// Api Providers End:---------------------------------------------------------
